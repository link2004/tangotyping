<template>
  <div class="py-5 text-left">
    <div class="bg-white shadow" style="border-radius: 2rem;">
      <h1 class="text-center pt-5">利用規約</h1>
      <div class="p-5">
        <h2>利用規約</h2>
        <p>この利用規約（以下，「本規約」といいます。）は，サービス運営者（以下，「運営者」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
        <h2>ベータ版について</h2>
        <p>本サービスは開発途中のベータ版となっています。</p>
        <p>運営者が仕様変更の課程で「ユーザー情報」または「単語帳のデータ」をユーザーの承諾なく削除、変更する可能性があります。</p>
        <h2>第1条（適用）</h2>
        <ol>
