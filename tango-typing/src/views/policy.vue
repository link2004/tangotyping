<template>
  <div class="py-5 text-left">
    <div class="bg-white shadow" style="border-radius: 2rem;">
      <h1 class="text-center pt-5">プライバシーポリシー</h1>
      <div class="p-5">
        <p>サービス運営者（以下，「運営者」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
